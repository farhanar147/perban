...
<body>
    <div style="padding: 15px;">
        ...
        <hr />
        <h3 style="margin-top: 0;"><b>Laporan Donasi yang telah disalurakan</b></h3>
        ...
        if(empty($tgl_awal) or empty($tgl_akhir)){ // Cek jika tgl_awal atau tgl_akhir kosong, maka :
            ...
            $url_cetak = "printposko.php";
            $label = "Semua Data Donasi";
        }else{ // Jika terisi
            // Buat query untuk menampilkan data transaksi sesuai periode tanggal
            $query = "SELECT * FROM tb_tdonasi  WHERE tb_tdonasi.status = '2' AND (waktu_donasi BETWEEN '".$tgl_awal."' AND '".$tgl_akhir."')";
            $url_cetak = "printposko.php?tgl_awal=".$tgl_awal."&tgl_akhir=".$tgl_akhir."&filter=true";
